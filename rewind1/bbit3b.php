...
$unsorted="'Joy is the serious business of heaven.'.LEWIS,CLIVE STAPLES.1964-01-01.https://bit.ly/2HwPJd6
...
<ol class="list-group">
<?php foreach($paragraph as $lines){
  // quote
 $endofquote = strrpos($lines,".'.");
 $data = substr($lines, $endofquote);
 $quote = str_replace("'","",substr($lines, 0, $endofquote));
// first name part
